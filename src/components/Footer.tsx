        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="mailto:contact@wynagency.com.br" className="hover:text-white transition-colors">
                  contact@wynagency.com.br
                </a>
              </li>
              <li>
                <a href="tel:+34663836731" className="hover:text-white transition-colors">
                  +34 663 836 731
                </a>
              </li>
              <li>Gran vía, 6 - Madrid - Spain</li>
            </ul>
          </div>
